...
***************************************************************************/
#ifndef EXTERNAL_INTERFACE_ANDROID_WISELIB_APPLICATION_H
#define EXTERNAL_INTERFACE_ANDROID_WISELIB_APPLICATION_H
...
namespace wiselib
{
   ...
   class WiselibApplication<AndroidOsModel, Application_P>
   {
   public:
      typedef AndroidOsModel OsModel;
      typedef Application_P Application;
      void init(AndroidOsModel& os)
      {
         app.init(os);
      };
   private:
